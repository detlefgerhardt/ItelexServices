	...
	public partial class MainForm : Form
	{
		...
		public MainForm()
		{
			...
			IncomingConnectionManagerConfig config = new IncomingConnectionManagerConfig()
			{
				...
				MonitorServerType = ItelexCommon.Monitor.MonitorServerTypes.ItelexBaudotArtServer,
			...
			MainServiceCtrl.StartIncomingConnections<BaudotArtConnectionManager>(config);

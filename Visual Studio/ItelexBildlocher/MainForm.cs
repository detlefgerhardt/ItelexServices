	...
	public partial class MainForm : Form
	{
		...
		public MainForm()
		{
			...
			IncomingConnectionManagerConfig config = new IncomingConnectionManagerConfig()
			{
				...
				MonitorServerType = ItelexCommon.Monitor.MonitorServerTypes.ItelexBildlocher,
			...
			MainServiceCtrl.StartIncomingConnections<BildlocherConnectionManager>(config);

			//EyeballChar ec = new EyeballChar();
			//ec.GetPunchCodesFromAscii("hallo-");
		}
